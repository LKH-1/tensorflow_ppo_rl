...
class CNNAgent:
    def __init__(self, sess, obs_stack, window_size, frame_skip, output_size):
        self.name = 'network'
        self.sess = sess
        ...
        self.model = CNNActorCritic(self.name, self.obs_stack, self.window_size, self.output_size)
        self.gamma = 0.99
